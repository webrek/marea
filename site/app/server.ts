...
import { __almacen, __register, __malFormado, __rpc, print, concat, render, len, aTexto, escapar, html, __div, __rem, unir, agregar, largo, contiene, minusculas, pedir, pedirPost, jsonTexto, jsonNumero, jsonDecimal, jsonLargo, __index, guardar, todos, actualizar, borrar, __marea_is, __signal, __memo, __effect } from "./runtime.ts";
